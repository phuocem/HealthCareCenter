      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            _buildDetailRow(Icons.phone_rounded, 'SỐ ĐIỆN THOẠI', phone, const Color(0xFF10B981)),
            const Divider(color: Color(0xFFE2E8F0), height: 24, thickness: 1),
            _buildDetailRow(Icons.contact_phone_rounded, 'LIÊN HỆ KHẨN CẤP', 'Người thân - 0987 654 321', const Color(0xFFF59E0B)),
          ],
        ),
      );
    });
