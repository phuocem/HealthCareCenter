...
export default function HomeScreen() {
  ...
  const menuItems = [
    ...
    { title: 'Tìm bác sĩ', icon: 'search-outline', screen: 'SearchDoctorScreen' },
...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 36, fontWeight: '800', color: '#FFFFFF', marginTop: 4, letterSpacing: -0.5 },
  ...
  newsText: { fontSize: 14, color: '#4B5563', marginLeft: 10, fontWeight: '500' },
});