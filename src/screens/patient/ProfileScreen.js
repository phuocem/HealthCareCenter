    ...
    >
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(800)} style={styles.header}>
          ...
          <Animated.Text entering={FadeInUp.delay(300).duration(600)} style={styles.name}>
            {profile.name}
          </Animated.Text>
          <Animated.Text entering={FadeInUp.delay(400).duration(600)} style={styles.role}>
        ...
        <Animated.View entering={FadeInUp.delay(600).duration(800)} style={styles.card}>
          <View style={styles.cardInner}>
            <View style={styles.infoContainer}>
              ...
              <InfoItem icon="human-male-female" label="Giới tính" value={formatGender(profile.gender)} delay={300} />
              <InfoItem icon="cake" label="Ngày sinh" value={formatDate(profile.date_of_birth)} delay={400} />
              <InfoItem icon="shield-account" label="Vai trò" value={formatRole(profile.role)} delay={500} />
            </View>
...
const styles = StyleSheet.create({
  ...
  loadingText: { marginTop: 16, fontSize: 18, color: '#E5E7EB', fontWeight: '600' },
  ...
  name: { fontSize: 28, fontWeight: '800', color: '#FFFFFF', textShadowColor: 'rgba(0,0,0,0.2)', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 4 },
  ...
  value: { fontSize: 17, color: Colors.textPrimary, fontWeight: '700', marginTop: 4 },

  // Button
  editButton: { borderRadius: 18, overflow: 'hidden', elevation: 8, shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.15, shadowRadius: 12 },
  editButtonGradient: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  editButtonText: { color: '#FFF', fontSize: 17, fontWeight: '700', marginLeft: 10 },
